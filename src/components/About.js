        ...
        <>
            <div className="bg-[#ff620e] flex justify-between items-center">
                <div className="shadow-xl m-20">
                    <p className="text-6xl text-white text-center m-10 font-bold pt-10 tracking-wider" style={{ "fontFamily": "Yanone Kaffeesatz" }}>
                        WHAT WE DO
                    </p>
                    <p className="pl-60 pr-60 pb-40 text-white font-thin tracking-wider text-xl" style={{ "fontFamily": "Montserrat" }}>
