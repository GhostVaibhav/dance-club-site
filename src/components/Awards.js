            ...
            <div className="bg-white justify-between items-center">
                ...
                <div className="text-center grid grid-cols-3 justify-items-center gap-4 mt-20 pb-20" style={{ "fontFamily": "Montserrat" }}>
                    <div class="max-w-sm rounded overflow-hidden shadow-xl">
                        <p className="text-center pt-10 pl-24 pr-24 font-bold text-4xl">1240+</p>
                        <div class="px-6 py-4">
                            <p class="font-bold text-xl">Club</p>
                        </div>
                    </div>
                    <div class="max-w-sm rounded overflow-hidden shadow-xl">
                        <p className="text-center pt-10 px-40 font-bold text-4xl">2000+</p>
                        <div class="px-6 py-4">
                            <p class="font-bold text-xl">Active Members</p>
                        </div>
                    </div>
                    <div class="max-w-sm rounded overflow-hidden shadow-xl">
                        <p className="text-center pt-10 px-24 font-bold text-4xl">1.000+</p>
                        <div class="px-6 py-4">
                ...
                <div className="flex flex-col items-center">
                    <p className="text-6xl text-center m-auto font-bold pt-20 tracking-wider" style={{ "fontFamily": "Yanone Kaffeesatz" }}>JOIN US</p>
                    <p className="text-center pt-10 pl-60 pr-60 text-lg tracking-wider" style={{ "fontFamily": "Montserrat" }}>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempora itaque incidunt ad maxime nostrum error corporis voluptate illo nisi optio. Quas eius architecto ipsa accusamus placeat cupiditate voluptates! Numquam quasi minus laborum possimus fugiat excepturi itaque exercitationem velit, modi dolorum.</p>
