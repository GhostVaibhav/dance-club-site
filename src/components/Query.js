        ...
        return (
            <div className='flex justify-center bg-[#FF620E]'>
                <div className='flex flex-col items-center p-6 max-w-screen-xl'>
                    ...
                    <div>
                        <input className='p-4 my-4 sm:m-4 w-full sm:w-auto focus:outline-none focus:border-2 focus:border-[#494949]' style={{ "fontFamily": "Montserrat" }} type="text" placeholder="Your Query" />
                        <input className='p-4 my-4 sm:m-4 w-full sm:w-auto focus:outline-none focus:border-2 focus:border-[#494949]' style={{ "fontFamily": "Montserrat" }} type="email" placeholder="Email" />
                    </div>
